    ...
    <div class="container-fluid flex-grow-1">
        <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link link-dark" href="/teachers">
                                <span data-feather="chalkboard-teacher"></span>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <p>Це ваша інформаційна панель, де ви можете керувати всіма аспектами системи тестування студентів.</p>
            </main>
        </div>
    </div>
@endsection
